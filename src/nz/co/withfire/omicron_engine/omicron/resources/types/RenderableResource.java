...
import nz.co.withfire.omicron_engine.omicron.resources.loaders.RenderableLoader;
...
public class RenderableResource {
    ...
    //animation and sprite directions
    ...
    @param faceDirectio the direction of the face for the animation
    @param layerGroup the renderable group
    @param layer the layer of the renderable
    @param materialLabel the label of the material
    @param group the group of the resource*/
    public RenderableResource(Vector2 dim,
        int divisions, FaceDirection faceDirection,
        Renderable.Group layerGroup, int layer, String materialLabel,
        ResourceGroup group) {
    ...
    public RenderableResource(int resourceId, Vector2 dim,
        int divisions, FaceDirection faceDirection, Renderable.Group layerGroup,
        ...
        switch(type) {
            ...
            case SPRITE: {
                ...
                renderable = RenderableLoader.loadSprite(
                    layerGroup, layer, dim, divisions, faceDirection);
                break;
            }
            case ANIMATION: {
                
                renderable = RenderableLoader.loadAnimation(
                    context, resourceId, layerGroup,
                    layer, dim, divisions, faceDirection);
                break;
            }
        }
