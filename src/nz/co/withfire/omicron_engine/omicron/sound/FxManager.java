...
package nz.co.withfire.omicron_engine.omicron.sound;
...
public class FxManager {
    ...
    /**Frees the sound
    @param resourceId the resource id of the sound to free*/
    public static void unload(int resourceId) {
        
        soundPool.unload(resourceId);
    }
