...
public class CollisionDetect {
    ...
    public static boolean detect(Bounding a, Bounding b) {
        ...
        //two cubes
        else if (a instanceof BoundingCube && b instanceof BoundingCube) {
            
            return dectectCubeCube((BoundingCube) a,(BoundingCube) b);
        }
    ...
    /**Checks if there is a collision between two cubes
    @param a the first bounding cube
    @param b the second bounding cube
    @return if there is a collision*/
    private static boolean dectectCubeCube(
        BoundingCube a, BoundingCube b) {
        
        //short hand
        float ahdx = a.getDim().x;
        float ahdy = a.getDim().y;
        float ahdz = a.getDim().z;
        float ax1  = a.getPos().x - ahdx;
        float ax2  = a.getPos().x + ahdx;
        float ay1  = a.getPos().y - ahdy;
        float ay2  = a.getPos().y + ahdy;
        float az1  = a.getPos().z - ahdz;
        float az2  = a.getPos().z + ahdz;
        float bhdx = b.getDim().x;
        float bhdy = b.getDim().y;
        float bhdz = b.getDim().z;
        float bx1  = b.getPos().x - bhdx;
        float bx2  = b.getPos().x + bhdx;
        float by1  = b.getPos().y - bhdy;
        float by2  = b.getPos().y + bhdy;
        float bz1  = b.getPos().z - bhdz;
        float bz2  = b.getPos().z + bhdz;
